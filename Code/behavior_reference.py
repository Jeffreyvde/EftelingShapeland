...
# Parameters
# stay_time_preference: mean total park stay time, actual value will be drawn from a
#   normal distribution.
...
#   visits attractions, smaller values influence agents decision to vist attractions
...
BEHAVIOR_ARCHETYPE_PARAMETERS = {
    # Agent wants to stay for a long time, go on as many attractions as possible, doesn't want to visit activities,
    # doesn't mind waiting
    "ride_enthusiast": {
        "stay_time_preference": 540,
        "allow_repeats": True,
        "attraction_preference": 1.0,  # 0.6
        "wait_threshold": 60,  # 480
        "percent_no_child_rides": 0.0,
        "percent_no_adult_rides": 1.0,
        "percent_no_preference": 0.0
    },
    # Agent wants to go on a lot of attractions, but will visits activities occasionally,
    # will wait for a while in a queue
    "ride_favorer": {
        "stay_time_preference": 480,
        "allow_repeats": True,
        "attraction_preference": 0.9,  # 0.5
    ...
    # Agent wants to stay for a long time and wants to see attractions and activities equally, reasonable about wait
    # times
    "park_tourer": {
